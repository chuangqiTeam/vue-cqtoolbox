<template>
  <div class="cq-tooltip" :class="classes" :style="style">
    <span class="cq-tooltip-arrow"></span>
    <span class="cq-tooltip-inner">
      <slot></slot>
    </span>
  </div>
</template>

<style lang="scss" src="./cqTooltip.scss"></style>
    ...
    computed: {
      classes () {
        const cssClasses = {
          ...
          'cq-transition-off': this.transitionOff,
          'cq-tooltip-top': this.cqDirection === 'top',
          'cq-tooltip-right': this.cqDirection === 'right',
          'cq-tooltip-bottom': this.cqDirection === 'bottom',
          'cq-tooltip-left': this.cqDirection === 'left'
        }
      ...
      style () {
        return {
          'transition-delay': this.cqDelay + 'ms',
    ...
    methods: {
      ...
      calculateTooltipPosition () {
        ...
        switch (this.cqDirection) {
          ...
          case 'left':
            ...
            break
          default:
            console.warn(`Invalid ${this.cqDirection} option to cq-direction option`)
        }
      ...
      generateTooltipClasses () {
        ...
        this.parentElement.classList.forEach((cssClass) => {
          if (cssClass.indexOf('cq-') >= 0 && cssClass !== 'cq-active') {
